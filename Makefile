...
CC            = gcc
CXX           = g++
DEFINES       = -DSAILFISH -DQT_NO_DEBUG -DQT_QUICK_LIB -DQT_QML_LIB -DQT_WEBKIT_LIB -DQT_WIDGETS_LIB -DQT_NETWORK_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
INCPATH       = -I/usr/share/qt5/mkspecs/linux-g++ -I. -I/usr/include/sailfishapp -I/usr/include/mdeclarativecache5 -I/usr/include/qt5 -I/usr/include/qt5/QtQuick -I/usr/include/qt5/QtQml -I/usr/include/qt5/QtWebKit -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -Imoc
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath-link,/usr/lib
LIBS          = $(SUBLIBS) -pie -rdynamic -L/usr/lib/ -lsailfishapp -lmdeclarativecache5 -L/usr/lib -lQt5Quick -lQt5Qml -lQt5WebKit -lQt5Widgets -lQt5Network -lQt5Gui -lQt5Core -lGLESv2 -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = src/speedcrunch.cpp \
		...
		core/settings.cpp \
		bison/exprparser.c \
		src/manager.cpp moc/moc_constants.cpp \
		moc/moc_evaluator.cpp \
		moc/moc_functions.cpp \
		moc/moc_manager.cpp
OBJECTS       = obj/speedcrunch.o \
		obj/floatcommon.o \
		obj/floatconst.o \
		obj/floatconvert.o \
		obj/floaterf.o \
...
Makefile: speedcrunch.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d obj/speedcrunch1.0.0 || mkdir -p obj/speedcrunch1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/speedcrunch1.0.0/ && $(COPY_FILE) --parents math/floatcommon.h math/floatconfig.h math/floatconst.h math/floatconvert.h math/floaterf.h math/floatexp.h math/floatgamma.h math/floathmath.h math/floatincgamma.h math/floatio.h math/floatipower.h math/floatlog.h math/floatlogic.h math/floatlong.h math/floatnum.h math/floatpower.h math/floatseries.h math/floattrig.h math/hmath.h math/number.h core/constants.h core/errors.h core/evaluator.h core/functions.h core/settings.h bison/bison.h bison/bisonparser.h bison/exprparser.h src/manager.h obj/speedcrunch1.0.0/ && $(COPY_FILE) --parents src/speedcrunch.cpp math/floatcommon.c math/floatconst.c math/floatconvert.c math/floaterf.c math/floatexp.c math/floatgamma.c math/floathmath.c math/floatincgamma.c math/floatio.c math/floatipower.c math/floatlog.c math/floatlogic.c math/floatlong.c math/floatnum.c math/floatpower.c math/floatseries.c math/floattrig.c math/hmath.cpp math/number.c core/constants.cpp core/evaluator.cpp core/functions.cpp core/settings.cpp bison/exprparser.c src/manager.cpp obj/speedcrunch1.0.0/ && (cd `dirname obj/speedcrunch1.0.0` && $(TAR) speedcrunch1.0.0.tar speedcrunch1.0.0 && $(COMPRESS) speedcrunch1.0.0.tar) && $(MOVE) `dirname obj/speedcrunch1.0.0`/speedcrunch1.0.0.tar.gz . && $(DEL_FILE) -r obj/speedcrunch1.0.0
...
obj/speedcrunch.o: src/speedcrunch.cpp /usr/include/qt5/QtQuick/QtQuick \
		...
		/usr/include/qt5/QtCore/QDebug \
		/usr/include/qt5/QtGui/QClipboard
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/speedcrunch.o src/speedcrunch.cpp
...
install_qml: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/speedcrunch || mkdir -p $(INSTALL_ROOT)/usr/share/speedcrunch
	-$(INSTALL_DIR) /home/mersdk/Documents/projects/sailfish/speedcrunch_sailfish/speedcrunch/qml $(INSTALL_ROOT)/usr/share/speedcrunch/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/speedcrunch/qml
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/speedcrunch/ 


install_desktop: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/applications || mkdir -p $(INSTALL_ROOT)/usr/share/applications
	-$(INSTALL_PROGRAM) /home/mersdk/Documents/projects/sailfish/speedcrunch_sailfish/speedcrunch/speedcrunch.desktop $(INSTALL_ROOT)/usr/share/applications/
	-: $(INSTALL_ROOT)/usr/share/applications/speedcrunch.desktop

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/speedcrunch.desktop
...
install_icon: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/mersdk/Documents/projects/sailfish/speedcrunch_sailfish/speedcrunch/speedcrunch.png $(INSTALL_ROOT)/usr/share/icons/hicolor/90x90/apps/
	-: $(INSTALL_ROOT)/usr/share/icons/hicolor/90x90/apps/speedcrunch.png

uninstall_icon: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/90x90/apps/speedcrunch.png
